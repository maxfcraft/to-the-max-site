...
export const site = {
  ...
  base: "",
  name: "To The Max Marketing",
  legalName: "To The Max Marketing",
  ...
  /* THE ENTITY SENTENCE. 149 characters. Name matches the Google Business Profile (2026-09-22). Byte-identical in: the home page meta
  ...
  entity:
    "To The Max Marketing is a one-operator agency in Huntsville, Alabama running Meta ads, landing pages, and lead follow-up for local service businesses.",
